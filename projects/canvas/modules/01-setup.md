...
### 1.14 Env vars that tune the CLI
...
### 1.15 Cleanup with `claude project purge`
...
Useful when archiving completed projects, freeing disk after long sessions, or scrubbing transcripts before handing off code.
...
### 1.16 Windows: PowerShell as primary shell
