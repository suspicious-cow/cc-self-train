...
| 3 | [Rules, Memory & Context](modules/03-rules-memory-context.md) | Coding standards, context management, blog page | .claude/rules/, CLAUDE.local.md, @imports, /context, /compact, /stats, /cost, /statusline |
