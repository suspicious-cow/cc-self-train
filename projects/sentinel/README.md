...
Create a new directory for Sentinel outside the cc-self-train repo. Each project is its own repository.
...
- [ ] `sentinel/` directory exists with `git init` completed
