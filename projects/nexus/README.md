...
| 3 | .claude/rules/, @imports, /context, /compact, /stats, /cost, /statusline | Rate limiting |
...
| 3 | [Rules, Memory & Context](modules/03-rules-memory-context.md) | Rate limiting | .claude/rules/, @imports, /context, /compact, /stats, /cost, /statusline |
