...
### 1.12 Env vars that tune the CLI
...
### 1.13 Cleanup with `claude project purge`
...
Useful when retiring an old gateway prototype, freeing disk after long sessions, or scrubbing transcripts before handing off code.
...
### 1.14 Windows: PowerShell as primary shell
