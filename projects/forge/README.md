...
| 3 | [Rules, Memory & Context](modules/03-rules-memory-context.md) | Conventions, context management | .claude/rules/, CLAUDE.local.md, @imports, /context, /compact, /stats, /cost, /statusline |
